...
_TEST_NAME_SYNONYMS: dict[str, str] = {
    ...
    # --- CBC extended (indices, differential, absolutes, platelet indices, ESR) ---
    "rbc": "RBC Count",
    "rbc count": "RBC Count",
    ...
    # --- Sensitive / not-assessed tests: recognized ONLY so the coverage
    #     policy can ACKNOWLEDGE them correctly (never graded — see
    #     medical/coverage.py). These are NOT assessable. ---
    "psa": "PSA",
    "total psa": "PSA",
    ...
    "cortisol": "Cortisol",
    "vdrl": "VDRL",
    # --- Deferred numeric (recognized so they acknowledge as NUMERIC) ---
    "hs-crp": "hs-CRP",
    "hs crp": "hs-CRP",
